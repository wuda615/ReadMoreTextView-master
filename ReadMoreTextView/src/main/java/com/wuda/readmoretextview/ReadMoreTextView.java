 ...
 */
package com.wuda.readmoretextview;
...
import com.borjabravo.readmoretextview.R;
...
public class ReadMoreTextView extends TextView {
    ...
    private CharSequence getTrimLineText(int line) {
        ...
        int lineEnd = getLayout().getLineEnd(line) < length ? getLayout().getLineEnd(line) : length;
